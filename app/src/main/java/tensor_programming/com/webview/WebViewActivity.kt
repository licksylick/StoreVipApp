...
class WebViewActivity : Activity(){
    ...
    private val URL = "https://storevip.ru"
    private var isAlreadyCreated = false

    private class SVWebViewClient: WebViewClient(){

        override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
            Log.e("tag", request?.url?.host.toString())
            if (request?.url?.host.equals("storevip.ru"))
                return false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webView.webViewClient =  SVWebViewClient()
